...
function nextPose(){
  if (poseCounter >= 4) {
    ...
    document.getElementById("finish").textContent = "Congratulations you completed all the poses";
    // finish.style.width = "100vw"
    // finish.style.height = "100vh"
    ...
    document.getElementById("poseName").textContent = target;
    document.getElementById("welldone").textContent = "";
    // document.getElementById("totolscore").textContent = "Well done,";
    document.getElementById("sparkles").style.display = 'none';
    document.getElementById("poseImg").src = imgArray[poseCounter].src;
